    ...
    partial class Weapons
    {
        WeaponDefinition OctoBeam => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[]
                {
                    new MountPointDef
                    {
                        ...
                        AimPartId = "GazerBeamLenses",
                        MuzzlePartId = "GazerBeamLenses",
                    },
					new MountPointDef
					{
            ...
            Targeting = new TargetingDef
            {
                Threats = new[]
                {
                    Grids, Characters, Projectiles, Meteors, // Grids, Biological, Projectiles, Repel, Meteors - threats percieved automatically without changing menu settings
                },
                SubSystems = new[]
                {
            ...
            HardPoint = new HardPointDef
            {
                ...
                {
                    PreFiringSound = "",
                    FiringSound = "BeamHum", // subtype name from sbc
